<template>
  ...
  <section
    id="hero"
    class="relative font-primary  min-h-screen flex items-center pt-20 overflow-hidden"
  >
        ...
        <div class="space-y-8 relative z-10">
          ...
          <div class="pt-4">
            <div class="flex items-center gap-3 mb-4">
              <div
                class="h-px w-12 bg-gradient-to-r from-blue-600 to-transparent"
              ></div>
              <p
                class="text-sm font-semibold text-gray-600 uppercase tracking-wider"
              >
                {{ content.socialTitle[locale] }}
              </p>
            </div>
            ...
            <div class="flex items-center gap-3">
              ...
              >
                <div
                  class="absolute inset-0 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 rounded-2xl"
                ></div>
                <div
                  class="relative flex flex-col items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:rotate-6 cursor-pointer"
                >
                  <svg
                    class="w-7 h-7 text-white transform group-hover:scale-110 transition-transform duration-300"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                    <path
              ...
              <a
                ...
                class="group relative"
              >
                <!-- blur opacity-50 group-hover:opacity-100 transition-opacity duration-500 -->
                <div class="absolute inset-0 bg-blue-600 rounded-2xl"></div>
                <div
                  class="relative flex flex-col items-center justify-center w-16 h-16 rounded-2xl bg-blue-600 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:rotate-6 cursor-pointer"
                >
                  <svg
                    class="w-7 h-7 text-white transform group-hover:scale-110 transition-transform duration-300"
                    fill="currentColor"
              ...
              >
                ...
                <div
                  class="relative flex flex-col items-center justify-center w-16 h-16 rounded-2xl bg-blue-500 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:rotate-6 cursor-pointer"
                >
                  <svg
                    class="w-7 h-7 text-white transform group-hover:scale-110 transition-transform duration-300"
                    fill="currentColor"
              ...
              <!-- YouTube -->
              <a
                href="https://youtube.com/@hedmarketing?si=PxF65AfK9pOXSDsf"
                target="_blank"
                rel="noopener noreferrer"
                class="group relative"
              >
                <!-- blur opacity-50 group-hover:opacity-100 transition-opacity duration-500 -->
                <div class="absolute inset-0 bg-red-600 rounded-2xl"></div>
                <div
                  class="relative flex flex-col items-center justify-center w-16 h-16 rounded-2xl bg-red-600 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:rotate-6 cursor-pointer"
                >
                  <svg
                    class="w-7 h-7 text-white transform group-hover:scale-110 transition-transform duration-300"
                    fill="currentColor"
